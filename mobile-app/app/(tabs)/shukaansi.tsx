    ...
    try {
      ...
      if (response.ok) {
        if (data.length > 0) {
          ...
          setMessages([{ id: 'welcome', text: 'Kusoo dhawoow! Anigu waxaan ahay "My Love". Maxaan kaa caawin karaa maanta?', sender: 'ai' }]);
        }
      }
    } catch (error) {
          ...
          <View style={styles.inputWrapper}>
            ...
            <View style={styles.textInputContainer}>
              <TextInput 
                ...
                placeholder={isTranscribing ? "Aqoonsanaya codka..." : "Message My Love..."}
        ...
        <View style={{ flex: 1, paddingTop: Math.max(insets.top, 20) }}>
          ...
          <ScrollView style={styles.sidebarContent}>
            <View style={styles.pointsCard}>
              <View style={styles.pointsHeaderRow}>
                ...
                <Text style={styles.pointsAmount}>
                  {subscriptionType === 'monthly_11' ? 'Premium (Unlimited)' :
                   ...
                   credits !== null ? `${credits} Coins` : 'Loading...'}
                </Text>
              </View>
              <Text style={styles.pointsDesc}>
                Waxaad haysataa {credits || 0} dhibcood oo gaar u ah Shukaansiga. Farriin kasta oo aad dirto ama sawir waxay kaa jaraysaa dhibco.
              </Text>
              ...
              >
                <Text style={styles.buyButtonText}>Dalbo Dhibco Kale</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  messageBubbleAi: {
    backgroundColor: '#F2F2F7', // iOS WhatsApp incoming message background
