...
const INITIAL_MESSAGES: Message[] = [
  { id: '1', text: 'Kusoo dhawoow! Anigu waxaan ahay darkpen ai. Maxaan kaa caawin karaa maanta?', sender: 'ai', status: 'complete' }
];
...
export default function ChatScreen() {
  ...
  useEffect(() => {
    // Looping animation for thinking dots
    const animateDots = () => {
      Animated.sequence([
        Animated.stagger(200, [
          Animated.sequence([Animated.timing(thinkingDot1, { toValue: -5, duration: 200, useNativeDriver: true }), Animated.timing(thinkingDot1, { toValue: 0, duration: 200, useNativeDriver: true })]),
          Animated.sequence([Animated.timing(thinkingDot2, { toValue: -5, duration: 200, useNativeDriver: true }), Animated.timing(thinkingDot2, { toValue: 0, duration: 200, useNativeDriver: true })]),
          Animated.sequence([Animated.timing(thinkingDot3, { toValue: -5, duration: 200, useNativeDriver: true }), Animated.timing(thinkingDot3, { toValue: 0, duration: 200, useNativeDriver: true })]),
        ]),
        Animated.delay(500)
      ]).start(() => animateDots());
    };
  ...
  return (
    <AuthGuard>
      <View style={styles.container}>
        ...
        <View style={[styles.header, { top: Math.max(insets.top, 10) }]}>
          <View style={styles.headerLeft}>
            ...
            <BlurView intensity={40} tint="light" style={styles.nameBadgeBlur}>
              <Text style={styles.aiName}>Dark Pen</Text>
            </BlurView>
          </View>
          ...
          <View style={styles.headerRight}>
            ...
            <TouchableOpacity onPress={() => setMessages(INITIAL_MESSAGES)} activeOpacity={0.7}>
              <BlurView intensity={60} tint="light" style={styles.headerIconBlurBox}>
            ...
            <TouchableOpacity onPress={toggleSidebar} activeOpacity={0.7}>
              <BlurView intensity={60} tint="light" style={styles.headerIconBlurBox}>
                <Ionicons name="menu-outline" size={22} color={colors.secondary} />
              </BlurView>
            </TouchableOpacity>
          </View>
        </View>
                      ...
                      <View style={styles.aiContentContainer}>
                        {msg.status === 'thinking' ? (
                          <View style={styles.thinkingContainer}>
                            <Animated.View style={[styles.thinkingDot, { transform: [{ translateY: thinkingDot1 }] }]} />
                            <Animated.View style={[styles.thinkingDot, { transform: [{ translateY: thinkingDot2 }] }]} />
                            <Animated.View style={[styles.thinkingDot, { transform: [{ translateY: thinkingDot3 }] }]} />
          ...
          <View style={styles.inputContainer}>
            <View style={styles.inputWrapper}>
              ...
              <View style={styles.textInputContainer}>
                <TextInput
                  style={styles.input}
                  placeholder={isTranscribing ? 'Waa la fasirayaa codka...' : "Su'aal halkan ku qor..."}
        ...
        <Animated.View
          style={[styles.attachSheet, { transform: [{ translateY: attachAnim }] }]}
          ...
          <View style={{ flex: 1, paddingTop: Math.max(insets.top, 20) }}>
            ...
            <View style={styles.creditsSection}>
              <View style={styles.creditsCard}>
                ...
                <View style={styles.creditsInfo}>
                  <Text style={styles.creditsLabel}>{subscriptionType ? 'Qorshahaaga' : 'Credit-kaaga'}</Text>
                  <Text style={styles.creditsValue}>
                    {subscriptionType === 'monthly_11' ? 'Premium (Unlimited)' :
                      subscriptionType === 'monthly_3' ? 'Basic (Unlimited)' :
              ...
              {!subscriptionType && (
                ...
                >
                  <Text style={styles.topupBtnText}>Ku dar Credits</Text>
            ...
            <View style={styles.sidebarFooter}>
              <TouchableOpacity style={styles.footerItem} onPress={() => router.push('/profile')}>
                ...
                <Text style={[styles.footerItemText, { color: colors.primary }]}>Profile Settings</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Animated.View>
