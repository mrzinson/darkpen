  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text style={[styles.tabText, activeTab === 'your' && styles.activeTabText]}>Your Groups</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.tab, activeTab === 'other' && styles.activeTab]} 
          onPress={() => setActiveTab('other')}
        >
          <Text style={[styles.tabText, activeTab === 'other' && styles.activeTabText]}>Other Groups</Text>
        </TouchableOpacity>
      </View>
