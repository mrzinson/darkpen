              ...
              <React.Fragment key={msg.id || index}>
                ...
                <View style={[styles.messageRow, isMe ? styles.myRow : styles.otherRow]}>
                  <View style={[
                    ...
                    {showSender && <Text style={[styles.senderName, { color: getUserColor(msg.sender_name) }]}>{msg.sender_name}</Text>}
                    
                    {msg.type === 'image' ? (
                      <Image source={{ uri: msg.message }} style={styles.messageImage} resizeMode="cover" />
                    ) : (
                      <Text style={[styles.messageText, isMe && { color: 'white' }]}>{msg.message}</Text>
                    )}
