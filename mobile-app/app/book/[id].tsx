...
const mockBooks: Record<string, any> = {
  ...
  'default': { title: 'Buugga Waxbarashada', grade: 'Form 4', chapters: 8, pages: 150, size: '10 MB', year: '2016', image: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=400&auto=format&fit=crop', desc: 'Buug ka mid ah buugaagta waxbarashada dugsiyada sare ee Somaliland.' }
};
